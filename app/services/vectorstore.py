...
_TARGET_AGENT_DEFAULT_SCOPE = {
    ...
    "hybrid_research": "global",  # règles de composition filtres + thème : comportement système
...
async def add_memory(
    ...
    - ``target_agent`` : agent qui devra lire ce souvenir (supervisor,
      sql_research, semantic_research, hybrid_research, statistics, conversational,
      memory).
